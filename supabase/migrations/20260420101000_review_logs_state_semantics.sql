-- Record state/step/bury semantics in review_logs for Anki-style replayability.
-- Keeps fn_process_review_atomic signature unchanged for API compatibility.
...
begin
  ...
  insert into public.review_logs (
    ...
    p_request_id,
    v_current.state,
    v_current.learning_step,
    coalesce(v_current.buried_until, 0),
    p_state,
    p_learning_step,
    p_buried_until
  )
